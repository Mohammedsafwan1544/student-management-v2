...
mongoose.connect('mongodb+srv://mohammedsafwan1544:safwan1544@cluster0.i46iqu1.mongodb.net/', {
...
web.post('/admin/add-user', (req, res) => verifyToken(req.headers['authorization'], adminSecretKey, req, res, async () => {
...
web.post('/admin/assign-task', (req, res) => verifyToken(req.headers['authorization'], adminSecretKey, req, res, async () => {
...
web.get('/user/tasks', (req, res) => verifyToken(req.headers['authorization'], studentSecretKey, req, res, async () => {
  try {
...
web.put('/user/done/:taskId', (req, res) => verifyToken(req.headers['authorization'], studentSecretKey, req, res, async () => {
